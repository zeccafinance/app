            ...
            ((["string", "number"].includes(
              ...
              wrong_chain ? (
                <Wallet
                  ...
                  className="w-full rounded-xl text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66]  flex items-center justify-cente text-base font-medium space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3"
                >
