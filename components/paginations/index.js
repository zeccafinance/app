...
export const PageWithText = ({
  ...
  size,
  onClick,
  activeClassNames = "btn btn-default rounded-xl text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66] shadow ",
...
export const Page = ({
  ...
  active,
  onClick,
  activeClassNames = "btn btn-circle text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66]",
