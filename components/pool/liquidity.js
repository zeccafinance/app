                    ...
                    <div className="flex items-start px-2 pt-2 pb-3 space-x-2 bg-opacity-50 rounded-xl bg-yellow-50 dark:bg-yellow-200 dark:bg-opacity-10">
                      ...
                      <div className="flex flex-col space-y-3">
                        ...
                        <div className="flex flex-col space-y-0">
                          <div className="w-fit   bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66] rounded-xl flex items-center space-x-1 pt-0.5 pb-1 px-2">
                            <a
              ...
              <div className="flex items-end">
                {!valid_amount ? (
                  ...
                  <Wallet
                    ...
                    className="w-full rounded-xl text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66] flex items-center justify-center text-base font-medium space-x-1.5 sm:space-x-2 py-3 px-2 sm:px-3"
                  >
                  ...
                  <Wallet
                    ...
                    className="w-full px-2 py-3 text-base font-medium text-center rounded-xl text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66] sm:px-3"
                  >
            ...
            <>
              ...
              <div className="flex items-end">
                {!valid_amount ? (
                  ...
                  <Wallet
                    connectChainId={chain_id}
                    className="w-ful text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66]  rounded-xl flex items-center justify-cente text-base font-medium space-x-1.5 sm:space-x-2 py-3  px-2 sm:px-3"
                  >
                    <span className="mr-1.5 sm:mr-2">
                      {is_walletconnect ? "Reconnect" : "Switch"} to
                    </span>
