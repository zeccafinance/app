                    ...
                    (wrong_chain ||
                      ...
                      wrong_chain ? (
                        <Wallet
                          ...
                          className="w-full text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66]  rounded-xl flex items-center justify-center text-base font-medium space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3"
                        >
                      ...
                      <Wallet
                        ...
                        className="w-full px-2 py-3 text-base font-medium text-center rounded-xl  text-black bg-[#BBFF00] hover:bg-[#00CC66] dark:[#BBFF00] dark:hover:bg-[#00CC66]  sm:space-x-2 sm:py-4 sm:px-3"
                      >
